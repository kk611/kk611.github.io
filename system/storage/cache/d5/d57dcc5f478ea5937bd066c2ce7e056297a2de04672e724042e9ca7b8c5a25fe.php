...
/* __string_template__3e8954191b769910ffc038e9c5cfa9aff2ec2d0851d01529410016a0261cfc06 */
class __TwigTemplate_a73bfcf2ead5e0469a10aee1fdd548bc6ba47832e4ca6ee52cc1ff05ddefcab4 extends Twig_Template
{
        ...
        <div class=\"banner-grid\">
          ";
            ...
            if ($this->getAttribute($context["banner"], "link", array())) {
                ...
                echo "\" class=\"img-responsive img-center rounded-3\" style=\"height:80px\" /></a>";
            } else {
                echo "<img src=\"";
                echo $this->getAttribute($context["banner"], "image", array());
                echo "\" alt=\"";
...
";
    ...
    {
        return "__string_template__3e8954191b769910ffc038e9c5cfa9aff2ec2d0851d01529410016a0261cfc06";
    }
...
/*      */
/*         <div class="banner-grid">*/
/*           {% if banner.link %}<a  href="{{ banner.link }}"><img src="{{ banner.image }}" alt="{{ banner.title }}" class="img-responsive img-center rounded-3" style="height:80px" /></a>{% else %}<img src="{{ banner.image }}" alt="{{ banner.title }}" class="img-responsive img-center rounded-3" />{% endif %}*/
/*         </div>*/
