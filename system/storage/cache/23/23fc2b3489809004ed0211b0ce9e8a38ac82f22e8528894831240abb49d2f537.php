...
/* __string_template__647dc01bd81412de9acf1655a6f6f87160806384835d60229cde4ea6ea713e16 */
class __TwigTemplate_5bc658b77ff866f7453f90658a6cffeac9c3d657edbec3d208aa0a39718b9a40 extends Twig_Template
{
...
";
    ...
    {
        return "__string_template__647dc01bd81412de9acf1655a6f6f87160806384835d60229cde4ea6ea713e16";
    }
...
/*      */
/*         <div class="banner-grid">*/
/*           {% if banner.link %}<a style="height:80px" href="{{ banner.link }}"><img src="{{ banner.image }}" alt="{{ banner.title }}" class="img-responsive img-center rounded-3" /></a>{% else %}<img src="{{ banner.image }}" alt="{{ banner.title }}" class="img-responsive img-center rounded-3" />{% endif %}*/
/*         </div>*/
